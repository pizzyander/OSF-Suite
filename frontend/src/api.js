...
export const api = {
  ...
  endMeeting:     (token, id)          => request('POST', `/meetings/${id}/end`, null, token),
  ...
  getUploadUrl:   (token, id, filename) => request('GET', `/meetings/${id}/upload-url?filename=${encodeURIComponent(filename)}`, null, token),
